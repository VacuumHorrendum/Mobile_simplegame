...
public class Second extends AppCompatActivity implements View.OnClickListener {
   ...
   protected void onStart() {
      super.onStart();
      textObjectPartA = (TextView)findViewById(R.id.textView2);
      textObjectPartB = (TextView)findViewById(R.id.textView4);
      textObjectScore = (TextView)findViewById(R.id.textScore);
      textObjectLevel = (TextView)findViewById(R.id.textLevel);
      buttonObjectChoice1 = (Button)findViewById(R.id.button4);
      buttonObjectChoice2 = (Button)findViewById(R.id.button5);
      buttonObjectChoice3 = (Button)findViewById(R.id.button6);
      ...
      textObjectPartA.setVisibility(View.VISIBLE);
   }
